...
signed main() {
    ...
    CASET {
        ...
        vi good(a*b);
        FOR(i, 0, a*b) if (i%a%b != i%b%a) good[i] = 1;
        FOR(i, 1, a*b) good[i] += good[i-1];
        ...
        FOR(i, 0, q) {
            ...
            int res = 0;
            if (l/(a*b) == r/(a*b)) {
                res += good[r%(a*b)] - (l%(a*b)==0?0:good[l%(a*b)-1]);
            } else {
                res += good[a*b-1] - (l%(a*b)==0?0:good[l%(a*b)-1]);
                res += (r/(a*b) - l/(a*b) - 1) * good[a*b-1];
                res += good[r%(a*b)];
            }
            cout << res << ' ';
        }
